@props(['title' => __('Parolayı Onayla'), 'content' => __('Güvenliğiniz için, lütfen parolanızı giriniz.'), 'button' => __('Onayla')])
...
<x-jet-dialog-modal wire:model="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <x-jet-input type="password" class="mt-1 block w-3/4" placeholder="{{ __('Parola') }}"
